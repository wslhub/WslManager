...
namespace WslManager.Controls
{
    ...
    /// Copyright © 2002 - 2020, Interact Software Ltd. Please direct all Web site inquiries to webmaster@interact-sw.co.uk
    /// </para>
    /// 
    /// <para>Windows Forms provides a built-in <see cref="ListView"/> control,
    ...
    /// things.</para>
    ///
    /// <para>This class derives from <see cref="ListView"/> and adds support
    /// for complex binding, through its <see cref="DataSource"/> and
    /// <see cref="DataMember"/> properties. These behave much like the
    /// equivalent properties on the =<see cref="DataGrid"/> control.</para>
    ///
    /// <para>Note that the primary purpose of this control is to illustrate
    ...
    /// bindable grid controls on the market.</para>
    /// 
    /// </remarks>
